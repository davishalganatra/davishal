...
MicAccessTool.prototype.checkLanguageBox = function() {
    ...
    var o = this.currentLanguage || this.locale.en,
        A = '<button title="' + o.btn_open + '" tabindex="1" id="mic-access-tool-general-button" class="mic-access-tool-general-button"><div><img src="https://cdn.userway.org/widgetapp/images/wheel_right_wh.svg" alt="' + o.btn_open + '" style="height:40px!important"></div></button><div id="mic-access-tool-box" class="mic-access-tool-box"><div class="mic-access-tool-box-header"><h5 style="font-size:20px !important;margin-left: 20px;margin-top: 10px;">Help & Accessibility</h5><p style="margin-left: 20px;margin-top: 10px;font-size: 14px ! important;">Vishal's Personal Portfolio
